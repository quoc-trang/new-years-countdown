    ...
    setNamedItem(item) {
        ...
        if (item.name === 'id' || item.name === 'name') {
            if (this._ownerElement.parentNode &&
                this._ownerElement.parentNode.children &&
                item.value !== oldValue) {
                if (oldValue) {
                    (this._ownerElement.parentNode.children)._removeNamedItem(this._ownerElement, oldValue);
                }
                if (item.value) {
                    (this._ownerElement.parentNode.children)._appendNamedItem(this._ownerElement, item.value);
                }
            }
        }
    ...
    removeNamedItem(name) {
        ...
        if (removedItem.name === 'id' || removedItem.name === 'name') {
            if (this._ownerElement.parentNode &&
                this._ownerElement.parentNode.children &&
                removedItem.value) {
                (this._ownerElement.parentNode.children)._removeNamedItem(this._ownerElement, removedItem.value);
            }
        }
        if (this._ownerElement.attributeChangedCallback &&
            this._ownerElement.constructor._observedAttributes &&
